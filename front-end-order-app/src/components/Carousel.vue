<template>
  <section id="hero" class="position-relative overflow-hidden py-4" style="background: url(../src/assets/bike4-modified.jpg) no-repeat center center / cover;">
      ...
      <div class="container py-5 mt-5">
          <div class="row align-items-center py-5 mt-5">
              <div class="col-md-6 mb-5 mb-md-0">
                  ...
                  <p class="text-white">Welcome to NewBike GmbH — where craftsmanship meets innovation. Explore
