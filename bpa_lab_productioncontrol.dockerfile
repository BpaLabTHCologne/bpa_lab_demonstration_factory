...
WORKDIR /workdir/bpa_lab_productioncontrol_process
COPY --from=build /workdir/bpa_lab_productioncontrol_process/build/libs/bpa_lab_productioncontrol_process.jar bpa_lab_productioncontrol_process.jar
COPY bpa_lab_productioncontrol_process/bpmn /workdir/bpa_lab_productioncontrol_process/bpmn
CMD ["java", "-jar", "bpa_lab_productioncontrol_process.jar"]
